...
from primes_pythran import is_prime, print_primes
...
if __name__ == '__main__':
    ...
    for i in range(NUM_THREADS):
        ...
        print(f"Created {t} with {start=}, {stop=}", file=sys.stderr)
        threads.append(t)
    ...
    for t in threads:
        t.join()
    duration = time() - start
    print(f"{NUM_THREADS} Threads took {
          duration} seconds to complete", file=sys.stderr)
